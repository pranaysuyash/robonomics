...
export { researchReferences } from './references';
...
export const robots: Robot[] = [
  ...
  },
  {
    ...
    availability: 'Available',
    deploymentCount: 'Commercial deployment at GXO Spanx facility (Georgia); commercial agreement with Mercado Libre announced Dec 2025',
    description: 'Bipedal humanoid robot purpose-built for warehouse and light-manufacturing environments. Achieved major milestone: 100,000+ tote moves at GXO’s Flowery Branch facility, and Agility is expanding commercial deployments with Mercado Libre, GXO, Schaeffler, and Amazon.',
    ...
    specs: {
      ...
      'Commercial Partners': 'Mercado Libre, GXO, Schaeffler, Amazon',
    ...
    evidence: [
      ...
      { id: 'ev_digit_4', title: 'Agility and Mercado Libre Commercial Agreement', url: 'https://www.agilityrobotics.com/content/mercado-libre-and-agility-robotics-announce-commercial-agreement', type: 'Company Claim', verified: true, deploymentType: 'Production' }
    ],
    capabilities: [
      ...
      { taskId: 'task_gen_manipulate', successLevel: 'Full', confidenceScore: 75, evidenceIds: ['ev_digit_1', 'ev_digit_2', 'ev_digit_4'], notes: 'Moved 100,000+ totes in commercial operation, picking on/off AMRs and loading conveyors.' }
    ]
  },
  {
  ...
  },
  {
    ...
    pricingModel: 'Subscription (RaaS)',
    availability: 'Available',
    deploymentCount: 'Deployed across 10 countries, nearly a dozen retail sectors, and nearly five dozen retail leaders. 10-year anniversary Nov 2025.',
    description: 'Autonomous shelf-scanning robot. Launched Tally 4.0 Jan 2026 with 12-hour runtime (up from previous), enhanced vision, and edge AI. Celebrated 10 years Nov 2025 with 4.7M hours, 44.8B photos, 600M shelf gaps detected, and 80M promotion errors fixed. Now operates across grocery, mass merchandise, club, and specialty formats in 10 countries.',
    ...
    evidence: [
      { id: 'ev_tally_1', title: 'Simbe Marks 10 Years of Tally the Robot', url: 'https://www.simberobotics.com/about/newsroom/simbe-marks-10-years-of-tally-the-robot', type: 'Company Claim', verified: true, deploymentType: 'Production' },
    ...
    capabilities: [
      { taskId: 'task_inv_scan', successLevel: 'Superhuman', confidenceScore: 98, evidenceIds: ['ev_tally_1', 'ev_tally_2'], notes: 'Scans shelves far faster and more accurately than human workers. 600M shelf gaps detected, 80M promotion errors fixed, and 42% of shelf gaps fixed instantly.' }
    ]
  },
  {
    id: 'knightscope-k5',
  ...
  },
  {
    ...
    name: 'Optimus Gen 2',
    manufacturer: 'Tesla',
    pricingModel: 'TBD (internal development)',
  ...
  },
  {
    ...
    pricingModel: 'RaaS',
    availability: 'Available',
    deploymentCount: '2,700+ robots operating across 270+ locations in eight countries; 9M+ deliveries completed.',
    description: 'Pioneer in sidewalk delivery robots. Six-wheeled autonomous delivery. Global operations across 270+ locations in eight countries with 2,700+ robots and 9M+ deliveries completed. Robots make 125,000 road and driveway crossings daily.',
    videoUrl: 'https://www.youtube.com/embed/starship',
    limitations: ['Payload 10 kg', 'Campus limited', 'Speed limited'],
    specs: { 'Payload': '10 kg', 'Wheels': '6', 'Deliveries': '9M+', 'Robots': '2,700+', 'Locations': '270+', 'Countries': '8' },
    evidence: [{ id: 'ev_starship_1', title: 'Starship home page', url: 'https://www.starship.xyz/', type: 'Company Claim', verified: true, deploymentType: 'Production' }],
    capabilities: [{ taskId: 'task_case_unload', successLevel: 'Full', confidenceScore: 90, evidenceIds: ['ev_starship_1'], notes: '9M+ deliveries proven at scale across 270+ locations.' }]
  },
  {
    id: 'kiwibot',
    name: 'Kiwibot 4.0',
  ...
  },
  {
    ...
    pricingModel: 'RaaS',
    availability: 'Available',
    deploymentCount: '73 robots at Denver distribution center - 83% labor reduction; NAPA agreement adds 100+ robots for network handling',
    description: 'AI-powered mobile manipulator for warehouse picking. 83% labor reduction (120 FTEs to 20 per shift). Lights-out overnight operations. Autopicker 2.0 launched June 2025, and a February 2026 partnership with NAPA expands Brightpick into the automotive sector with 100+ robots planned.',
    ...
    specs: { 'Deployment': '73 robots Denver', 'Labor Reduction': '83%', 'Runtime': '24/7', 'Throughput': 'High', 'NAPA Partnership': '100+ robots planned' },
    evidence: [
      ...
      { id: 'ev_brightpick_3', title: 'Brightpick and NAPA Partnership Feb 2026', url: 'https://brightpick.ai/brightpick-napa-partnership/', type: 'Company Claim', verified: true, deploymentType: 'Production' }
    ],
    capabilities: [
  ...
  },
  {
    ...
    pricingModel: 'RaaS',
    availability: 'Available',
    deploymentCount: '100M+ autonomous decisions in production; operational validation with Sagawa Express in Tokyo',
    description: 'Physical AI for industrial robotics. Dual-armed "superhumanoid" robot Mech for truck loading. Foresight world model. 100M+ autonomous decisions in production, 0 safety incidents, and <400ms decision speed. Truck loading/unloading, palletizing, with onsite operational validation at Sagawa Express.',
    videoUrl: 'https://www.youtube.com/embed/dexterity',
    limitations: ['Narrow focus (truck loading)', 'Complex environment', 'Safety concerns'],
    specs: { 'Product': 'Mech', 'AI': 'Foresight world model', 'Actions': '100M+', 'Decision Speed': '<400ms', 'Safety Incidents': '0' },
    evidence: [
      { id: 'ev_dex_1', title: 'Dexterity home page', url: 'https://dexterity.ai/', type: 'Company Claim', verified: true, deploymentType: 'Production' },
      { id: 'ev_dex_2', title: 'Mech Begins Truck Loading Operational Validation with Sagawa Express', url: 'https://www.dexterity.ai/blog/mech-sagawa-express-x-relay', type: 'News', verified: true, deploymentType: 'Production' }
    ],
    capabilities: [
      { taskId: 'task_case_unload', successLevel: 'Full', confidenceScore: 92, evidenceIds: ['ev_dex_1', 'ev_dex_2'], notes: 'Dual-arm robot for truck loading - 100M+ decisions, 0 safety incidents, and Sagawa operational validation.' }
    ]
  },
  {
    id: 'jungheinrich-eac',
